        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por L4nder | 2023`, iconURL: `https://cdn.discordapp.com/avatars/1015278001610559509/89eaebbfb2f5d7661e3bc28506f363c8.webp?size=40` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`L4nder\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[L4nder](https://discord.gg/ecruXB7MGw)**`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por L4nder | 2023`, iconURL: `https://cdn.discordapp.com/avatars/1015278001610559509/89eaebbfb2f5d7661e3bc28506f363c8.webp?size=40` })
